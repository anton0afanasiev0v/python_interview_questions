...
В паттерне Blackboard несколько специализированных подсистем (источников знаний)
собирают свои знания для построения возможно частичного или приблизительного решения.
Таким образом, подсистемы совместно работают над решением проблемы,
где решение является суммой его частей.
